...
I downloaded 100 time calibrated phylogenetic trees for the subfamily Leptodactylinae from vertlife.org and obtained a consensus tree using package ape in r. The resulting tree was mostly composed of polytomies, therefore I chose to use a random tree from the posterior distribution of trees downloaded ![Figure 1](Final_Project/tree_frog.pdf).   
